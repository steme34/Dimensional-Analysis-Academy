...
## Chemistry Passport and Replay XP

The Academy now includes persistent replay progression stored with `localStorage`. First-time activity completions award 100 XP, replays award 25 XP, and completing all four activities as a replay cycle awards a 250 XP bonus. Levels, completion statistics, and achievements appear in the Chemistry Passport on the Academy home screen. The required assignment certificate continues to use session-based completion and remains separate from optional XP progression.
